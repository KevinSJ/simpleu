...
:SDall
set files=bat.txt Version.txt redirect.txt rd3rd.txt mobile.txt msoft.txt xunlei.txt game.txt active.txt soft.txt site.txt union.txt sitecn.txt unioncn.txt sitecbs.txt down.txt porn.txt email.txt operators.txt popups.txt
